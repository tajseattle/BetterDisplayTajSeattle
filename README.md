...
<a href="https://github.com/waydabber/BetterDisplay/releases/download/v3.5.5/BetterDisplay-v3.5.5.dmg"><img src="https://user-images.githubusercontent.com/37590873/219133640-8b7a0179-20a7-4e02-8887-fbbd2eaad64b.png" width="180" alt="Download for macOS"/></a><br/>
...
You can support development and unlock all features of the app by **[purchasing a Pro license for $19.99 / €19.99](https://betterdisplay.pro/buy)** (Currency may vary and Sales Tax or VAT may also apply depending on country/state). You can also get Pro inside the app - just navigate to `Settings` (gear icon) > `Pro` and click on `Buy BetterDisplay Pro`.
